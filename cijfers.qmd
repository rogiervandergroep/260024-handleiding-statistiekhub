...
Nieuwe cijfers (`observations`) (voor BBGA of voor andere publicatietabellen) voegen we toe of wijzigen we via de beheerwebsite van de statistiekhub. Je kan alleen cijfers toevoegen van indicatoren die zijn toegekend zijn aan jouw `team` (zie @sec-indicatoren).
...
Zorg dat het bestand voldoet aan de volgende naamgeving: `<datum>_<team>_cijfers.csv`  

- bijvoorbeeld: `20230208_veiligheid_cijfers.csv`
...
![Import Jobs](images/hub_import.png)

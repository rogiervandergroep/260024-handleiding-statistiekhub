...
![Afbeelding website add import jobs](images/hub_import.png) 
...
Dit komt bijvoorbeeld voor bij verkeerd ingevulde postcodes op enquetes, of als het gebied niet bestaat in een specifieke ruimtelijke indeling, maar wel waardes bevat.
...
Druk vervolgens onderaan op `save`. Daarna kom je terug in scherm 'import jobs' waar het geuploade bestand verschijnt.

![Afbeelding website add import jobs](images/hub_import2.png) 

Vink vervolgens dit bestand aan en selecteer bij `Action`: `perform dry-run`. Met een dry-run wordt getest of de aangeleverde data voldoen aan de voorwaarden. Er verschijnt een foutmelding als dit niet geval is. Bij `summary of changes made by this import` wordt duidelijk waar de fouten zitten.

![Afbeelding website add import jobs](images/hub_import1.png) 
